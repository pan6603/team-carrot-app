...
import { CarouselContentBottomTitle } from "../../styles/carousel/Carousel.styles";
import { CarouselContentBottomDescription } from "../../styles/carousel/Carousel.styles";
import { CarouselContentTopImg } from "../../styles/carousel/Carousel.styles";
import { CarouselItem } from "../../styles/carousel/Carousel.styles";
    ...
    return (
        <CarouselContainer>
            ...
            <CarouselWrapper>
                {slides.map((slide) => ( 
                            <CarouselItem>
                                <CarouselContentLink key={slide.id} >
                                    <CarouselContentTop>
