...
import { InnerFooter } from "../../styles/footer/Footer.styles";
import { NavFooterMenu } from "../../styles/footer/Footer.styles";
import { NavFooterMenuItem } from "../../styles/footer/Footer.styles";
import { NavFooterMenuItemLink } from "../../styles/footer/Footer.styles";
import { NavFooterMenuSns } from "../../styles/footer/Footer.styles";
import { NavFooterMenuSnsLink } from "../../styles/footer/Footer.styles";
import { StyledGithubIcon } from "../../styles/footer/Footer.styles";
import { StyledMediumIcon } from "../../styles/footer/Footer.styles";
import { StyledFacebookIcon } from "../../styles/footer/Footer.styles";
import { StyledInstagramIcon } from "../../styles/footer/Footer.styles";
